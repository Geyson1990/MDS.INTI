...
{
    public class TipoAreaMap: Profile
    {
        public TipoAreaMap()
        {
            /*
        ...
        CreateMap<USP_SEL_TIPO_AREA_Result, TipoAreaResponseDto>()
                .ForMember(des => des.IdTipoArea, opt => opt.MapFrom(src => src.ID_TIPO_AREA))
                .ForMember(des => des.DescTipoArea, opt => opt.MapFrom(src => src.DSC_TIPO_AREA))   
                .ForMember(des => des.AbreTipoArea, opt => opt.MapFrom(src => src.ABR_TIPO_AREA));
