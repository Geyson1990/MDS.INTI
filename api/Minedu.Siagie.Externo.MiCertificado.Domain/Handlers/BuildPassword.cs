...
namespace Minedu.Siagie.Externo.MiCertificado.Domain.Handlers
{
    public class BuildPassword : IBuildPassword
    {
        ...
        public bool Matches(string providedPassword, string passwordHash)
        {
            byte[] buffer4;
