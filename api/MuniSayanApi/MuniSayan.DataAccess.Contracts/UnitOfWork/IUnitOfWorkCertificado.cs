...
namespace MuniSayan.DataAccess.Contracts.UnitOfWork
{
    public partial interface IUnitOfWork : IBaseUnitOfWork
    {
        ...
        void SolicitudEstadoEmitido(int ID_SOLICITUD, int ID_PERSONA, string ID_MODALIDAD, string ID_NIVEL);
        ...
        Task<int> ConsultarSolicitudPorPersona(int ID_PERSONA);
        ...
        Task<int> UpdateEstadoEstudianteCertificado(int ID_SOLICITUD, string ESTADO_ESTUDIANTE);
        ...
        Task<int> UpdateEstadoCertificado(int ID_SOLICITUD, string ESTADO_SOLICITUD, string ESTADO_ESTUDIANTE);
