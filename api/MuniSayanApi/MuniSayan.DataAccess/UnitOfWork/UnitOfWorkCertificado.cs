        ...
        */
        public async Task<int> InsertUpdateInstitucion(IEEntity entity)
        {
            var parm = new Parameter[] {
                ...
                //new Parameter("@DRE" , entity.DRE),
                //new Parameter("@UGEL" , entity.UGEL),
                new Parameter("@ESTADO" , entity.ESTADO)
            };
        ...
        public async void SolicitudEstadoEmitido(int ID_SOLICITUD, int ID_PERSONA, string ID_MODALIDAD, string ID_NIVEL)
        {
            var parm = new Parameter[] {
        ...
        public async Task<int> ConsultarSolicitudPorPersona(int ID_PERSONA)
        {
            var parm = new Parameter[] {
                new Parameter("@ID_PERSONA", ID_PERSONA)
            };
        ...
        public async Task<int> UpdateEstadoEstudianteCertificado(int ID_SOLICITUD, string ESTADO_ESTUDIANTE)
        {
            var parm = new Parameter[] {
                new Parameter("@ID_SOLICITUD" , ID_SOLICITUD),
        ...
        public async Task<int> UpdateEstadoCertificado(int ID_SOLICITUD, string ESTADO_SOLICITUD, string ESTADO_ESTUDIANTE)
        {
            var parm = new Parameter[] {
                new Parameter("@ID_SOLICITUD" , ID_SOLICITUD),
